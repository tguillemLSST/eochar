...
class datafile :
    def __init__(self, fitsfile,Slow=True):
        ...
        try :
            ...
            self.filename=(fitsfile[0].header['FILENAME'])[:]
        except :
...
class cte :
    ...
    def plot_cte(self,ch,ccd_name,nf=0,on_screen=False) :
        # define last to plot :
        #ticks_flux=[1000.,10000.,50000.,1000000.,3000000.]
        #
        ...
        if self.serie :
            plotfile=root_plt+'_cte_serial.jpg' 
        else :
            plotfile=root_plt+'_cte_parallel.jpg'            
